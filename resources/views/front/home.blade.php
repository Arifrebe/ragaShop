...
<style>
    ...
    .feature-box { text-align: center; padding: 30px; border-radius: 10px; background: #fff; box-shadow: 0 5px 15px rgba(0,0,0,0.05); height: 100%; }
    .feature-icon { font-size: 40px; color: var(--primary-color); margin-bottom: 15px; }

    @media (max-width: 768px) {
        .slider_area .single_slider { height: auto !important; padding: 100px 0 60px 0; background-position: center right !important; }
        .slider_text h3 { font-size: 32px !important; line-height: 1.2; }
        .section_title h3 { font-size: 24px !important; }
        .product-content { padding: 10px; }
        .product-title { font-size: 13px; height: 36px; }
        .product-price { font-size: 15px; margin-bottom: 8px; }
        .feature-box { padding: 20px; margin-bottom: 15px; }
    }
</style>
@endsection
...
<div class="slider_area">
    <div class="single_slider slider_bg_1 d-flex align-items-center" style="background-image: url('{{ asset('assets/img/banner/banner.png') }}'); height: 80vh; background-size: cover;">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-8">
                    <div class="slider_text">
                        <h3 class="text-white" style="font-size: 45px; font-weight: 700;">Nutrisi & Cinta<br> Untuk Anabul</h3>
                        <p class="text-white mb-4 d-none d-md-block">Temukan berbagai pilihan makanan berkualitas tinggi dan perlengkapan terlengkap untuk hewan peliharaan Anda hanya di ragaShop Pets.</p>
                        <a href="{{ route('front.products') }}" class="btn-register header-btn" style="padding: 12px 30px !important; font-size: 15px !important;">Mulai Belanja</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="dog_thumb d-none d-lg-block"><img src="{{ asset('assets/img/banner/dog.png') }}" alt="Dog"></div>
    </div>
</div>
...
<div class="product_list_area pt-5 pb-5">
    <div class="container pt-4 pb-4">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-4 col-6 mb-4">
                <div class="product-item">
                    <div class="product-img-ratio"><img src="{{ asset('assets/img/elements/g1.jpg') }}" alt="Whiskas"></div>
            ...
            <div class="col-lg-3 col-md-4 col-6 mb-4">
                <div class="product-item">
                    <div class="product-img-ratio"><img src="{{ asset('assets/img/elements/g2.jpg') }}" alt="Pedigree"></div>
                    <div class="product-content">
            ...
            <div class="col-lg-3 col-md-4 col-6 mb-4">
                <div class="product-item">
                    <div class="product-img-ratio"><img src="{{ asset('assets/img/about/pet_care.png') }}" alt="Grooming"></div>
                    <div class="product-content">
            ...
            <div class="col-lg-3 col-md-4 col-6 mb-4">
                <div class="product-item">
                    <div class="product-img-ratio"><img src="{{ asset('assets/img/elements/g4.jpg') }}" alt="Pasir"></div>
                    <div class="product-content">
        ...
        <div class="row mt-3">
            <div class="col-12 text-center">
                <a href="{{ route('front.products') }}" class="header-btn" style="background: var(--primary-color); color: #fff; padding: 10px 25px !important; text-decoration:none;">Lihat Semua Produk</a>
            </div>
        </div>
    </div>
</div>
